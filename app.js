(async()=>{
 ...
 if(grid){
   try{
    ...
    const image=item=>`<picture><source srcset="/assets/images/${item.img}.webp?v=401" type="image/webp"><img src="/assets/images/${item.img}.jpg?v=401" alt="${tr(item,'name')}" loading="lazy" decoding="async" width="1400" height="1100"></picture>`;
